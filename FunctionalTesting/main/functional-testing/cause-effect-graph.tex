...
\includegraphics[scale=.04]{resources/Cause-effect graph/Cause-effect graph symbols}
\end{block}

\begin{block}{Restrictions symbols}
\includegraphics[width=\textwidth]{resources/Cause-effect graph/Cause-effect graph restrictions}
\end{block}
