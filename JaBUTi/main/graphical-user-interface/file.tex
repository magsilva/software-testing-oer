...
\begin{block}{Demo}
\includegraphics[width=\textwidth,clip]{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-OpenClass/JaBUTi-GUI-File-OpenClass}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-CloseProject/JaBUTi-GUI-File-CloseProject}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-SaveProject/JaBUTi-GUI-File-SaveProject}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-SaveAs/JaBUTi-GUI-File-SaveAs}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-SaveInstrumentedClasses/JaBUTi-GUI-File-SaveInstrumentedClasses}
\end{block}
\end{frame}
...
\begin{block}{Demo}
\insertmovie{resources/JaBUTi/JaBUTi-GUI/JaBUTi-GUI-File-Exit/JaBUTi-GUI-File-Exit}
\end{block}
\end{frame}
