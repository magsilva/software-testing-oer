...
\begin{center}
\includegraphics[width=.5\textwidth]{JaBUTi/JaBUTi-VendingMachine/JaBUTi-VendingMachine-Visualization-SourceCode}
\includegraphics[width=.5\textwidth]{JaBUTi/JaBUTi-VendingMachine/JaBUTi-VendingMachine-Visualization-Bytecode}
\end{center}
\end{frame}
